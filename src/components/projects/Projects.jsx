    ...
    <div id='projects' className='mt-24 scroll-m-20'>
      ...
      <section className='mx-4 flex flex-wrap gap-10 justify-evenly sm:flex-row '>
        {projectsList.map((project) => {
          return (
            <div key={project.id} className='flex-initial w-96 p-10 border-solid border-[#6D83F2] border-b-2 border-l-2 hover:cursor-pointer rounded-xl'>
              <img src={project.image} alt={project.title} className='w-64 h-36'/>
